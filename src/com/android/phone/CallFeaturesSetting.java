...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    static boolean mFlippingDownMutesRinger;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mFlippingDownMutesRinger.setChecked(mFlippingDownMutesRinger);
...
//====
    ...
    private void init(Context context, SharedPreferences pref) {
        ...
        mFlippingDownMutesRinger = pref.getBoolean(FLIPPING_DOWN_MUTES_RINGER_PREF, false);
    ...
    protected void onStop() {
        ...
        outState.putBoolean(FLIPPING_DOWN_MUTES_RINGER_PREF, mFlippingDownMutesRinger.isChecked());
